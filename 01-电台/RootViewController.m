...
//    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(musicCollectViewAppear) name:@"musicCollectViewAppear" object:nil];
}

//-(void)musicCollectViewAppear{
//    CYJCollectMusic *vc = [[CYJCollectMusic alloc]init];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"特别鸣谢" message:@"感谢《挖哇和微在》的数据支持!" preferredStyle:UIAlertControllerStyleAlert];
        UIAlertAction *okAction = [UIAlertAction actionWithTitle:@"确定" style:UIAlertActionStyleDefault handler:nil];
        [alert addAction:okAction];
        [self presentViewController:alert animated:YES completion:nil];
    }
